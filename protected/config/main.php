...
// CWebApplication properties can be configured here
	...
	$statusFlag=true;
	 ...
	 else
	 {
		...
		else if( strtolower($result['controller'])=='doctor' )
		{
			
			$themename = 'c2zoom_doctor';	
		}
		else
		{
			$themename = 'c2zoom';
	...
	'params'=>array(
		...
		'base_path'=>'http://'.WEB_HOST_NAME.'/c2zoom/index.php?r=',
		'base_url'=>'http://'.WEB_HOST_NAME.'/c2zoom/',
		'base_path_language'=>'http://'.WEB_HOST_NAME.'/c2zoom/js/',
		'image_path'=>'http://'.WEB_HOST_NAME.'/c2zoom/images',
		'msg'=>$msg,
		'adminmsg'=>$adminmsg,
		'errorCode'=>$errorCode,
