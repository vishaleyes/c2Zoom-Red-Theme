				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo Yii::app()->params->base_path ; ?>doctor/saveCholesterol" id="form_cholesterol" class="form-horizontal" method="post">
								<div class="form-body">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!--<div class="form-group">
                                                    ...
                                                    * </span>
													...
													{
													?>
                                                    <option <?php if(isset($cholesterolData['patient_id']) && ($cholesterolData['patient_id'])==$patient['patient_id']) { ?> selected="selected" <?php } ?> value="<?php echo $patient['patient_id'] ?>">
					...
					{?> selected="selected" <?php } ?> >mg/dL</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                * </span>
												...
												<div class="col-md-4">
											<input class="form-control form-control-inline input date-picker" data-required="1" size="16" data-date-format="mm/dd/yyyy" data-date-end-date="+0d"  data-date-start-date="-110y" autocomplete="off" placeholder="Ex. <?php echo date("m/d/Y") ?>" id="when" name="when" type="text" value="<?php 
					...
					?></textarea>
								...
								<div class="form-actions fluid">
                                    ...
                                    <input type="hidden" name="cholesterol_id" value="<?php echo $_REQUEST['cholesterol_id']; ?>"  />
										...
										<a class="btn red" href="<?php echo Yii::app()->params->base_path ; ?>doctor/cholesterolListing">Cancel</a>
									</div>
								</div>
							</form>
							<!-- END FORM-->
