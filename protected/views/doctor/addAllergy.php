				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo Yii::app()->params->base_path ; ?>doctor/saveAllergy" id="form_allergy" class="form-horizontal" method="post">
								<div class="form-body">
                                        ...
                                        <div class="col-md-6">
                                        	...
                                        	<!--<div class="form-group">
                                                    ...
                                                    * </span>
													...
													{
													?>
                                                    <option <?php if(isset($allergyData['patient_id']) && ($allergyData['patient_id'])==$patient['patient_id']) { ?> selected="selected" <?php } ?> value="<?php echo $patient['patient_id'] ?>">
					...
					?>"/ ><span class="col-md-6" style="color:red"><?php echo $validationError['treatmentErr'] ?></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                * </span>
												...
												<div class="col-md-8">
											<input class="form-control form-control-inline input date-picker" data-required="1" size="16" autocomplete="off" data-date-format="mm/dd/yyyy" data-date-start-date="-105y"  data-date-end-date="+0d" placeholder="Ex. <?php echo date("m/d/Y") ?>" id="first_observed" name="first_observed" type="text" value="<?php 
					...
					?></textarea>
								...
								<div class="form-actions fluid">
                                    ...
                                    <input type="hidden" name="allergy_id" value="<?php echo $_REQUEST['allergy_id']; ?>"  />
										...
										<a class="btn red" href="<?php echo Yii::app()->params->base_path ; ?>doctor/AllergyListing">Cancel</a>
									</div>
								</div>
							</form>
							<!-- END FORM-->
