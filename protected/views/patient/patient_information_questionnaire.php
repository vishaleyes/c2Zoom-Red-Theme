...
$arrMaritalStatus[0] = 'Married';
$arrMaritalStatus[1] = 'Widowed';
$arrMaritalStatus[2] = 'Seperated';
$arrMaritalStatus[3] = 'Divorsed';
$arrMaritalStatus[4] = 'Single';
$arrMaritalStatus[5] = 'Not specified';

$arrGender[0] = 'Female';
$arrGender[1] = 'Male';
$arrGender[2] = 'Not specified';

$arrEmploymentStatus[1] = 'Fulltime';
$arrEmploymentStatus[2] = 'Parttime';
$arrEmploymentStatus[3] = 'Retired';
$arrEmploymentStatus[4] = 'Disabled';
$arrEmploymentStatus[5] = 'Other';
...
<span class="ContentUnderline">Patient Information Questionnaire</span></h3>
    ...
    <div class="row">
    	<div class="col-sm-12">
    		<?php if (isset($isPDF) && $isPDF):?>
    			<p class="ContentPara">How did you learn about our practice? -
    				<?php echo (isset($_POST['howyoulearnaboutourpractice']) && !empty($_POST['howyoulearnaboutourpractice'])) ? $_POST['howyoulearnaboutourpractice'] : "";?>
    				<?php if ($_POST['howyoulearnaboutourpractice']=="Magazine"):?>
    					<?php echo (isset($_POST['Magazinetext']) && !empty($_POST['Magazinetext'])) ? $_POST['Magazinetext']: "";?>
    				<?php elseif ($_POST['howyoulearnaboutourpractice']=="Other (please name)"):?>
    					<?php echo (isset($_POST['Othertext']) && !empty($_POST['Othertext'])) ? $_POST['Othertext'] : "";?>
    				<?php endif;?> 
    			</p>
    			<h4 class="ContentParaTitle ContentUnderline">Physician Referring You To Our Practice:</h4>
	            <p class="ContentPara"><strong>Doctor Name</strong> - Dr. <?php echo (isset($_POST['dr']) && !empty($_POST['dr'])) ? $_POST['dr'] : "";?></p>
	            <p class="ContentPara"><strong>Phone #</strong> - <?php echo (isset($_POST['phone']) && !empty($_POST['phone'])) ? $_POST['phone'] :"";?></p>
	            <p class="ContentPara"><strong>Address</strong> - <?php echo (isset($_POST['address']) && !empty($_POST['address'])) ? $_POST['address'] :"";?></p>
    		<?php else:?>
            ...
            <p class="ContentPara"><strong>Doctor Name</strong> - Dr. <?php echo $doctorInfo[0]['name']." ".$doctorInfo['surname'];?></p>
            <p class="ContentPara"><strong>Phone #</strong> - <?php echo $doctorInfo[0]['doctor_mobile'];?></p>            
            <p class="ContentPara"><strong>Address</strong> - <?php echo $doctorInfo[0]['address'];?></p>
            <p>&nbsp;</p>
            <h4 class="ContentParaTitle ContentUnderline">Patient Information:</h4>
            <p class="ContentPara"><strong>Marital Status:</strong> - <?php echo $arrMaritalStatus[$patientData['marital_status']]; ?></p>
            <p class="ContentPara"><strong>Gender:</strong> - <?php echo $arrGender[$patientData['gender']]; ?></p>
    ...
    <div class="row">
    	<div class="col-sm-12">
            ...
            <p class="ContentPara"><strong>Employment Status:</strong> - <?php echo $arrEmploymentStatus[$patientInfo['employment_status']]; ?></p>
            ...
            <p class="ContentPara"><strong>Middle Name</strong> - <?php echo $patientInfo['mi']; ?></p>
            ...
            <p class="ContentPara"><strong>Group #</strong> - <?php echo $patientInfo['sec_insurance_grp']; ?></p>
