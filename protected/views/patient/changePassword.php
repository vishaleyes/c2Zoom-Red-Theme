				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo Yii::app()->params->base_path ; ?>patient/changePassword" id="form_change_password" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
								...
								<div class="form-actions fluid">
                                    ...
                                    <input type="hidden" name="patient_id" value="<?php echo $_REQUEST['patient_id']; ?>"  />
										...
										<a href="<?php echo Yii::app()->params->base_path ; ?>patient/patientHome"><button type="button" class="btn default">Cancel</button></a>
									</div>
								</div>
							</form>
							<!-- END FORM-->
...
function validateOldPassword()
		{
			...
			else
			{
				/*var k = document.forms["form_change_password"]["oldpassword"].value.length;
			              if(k<8)
                                {
							        document.getElementById("spanold").innerHTML="Please enter at least 8 characters";
							      return false;
                                }*/
...
function validateNewPassword()
		{
			...
			else
			{
				var k = document.forms["form_change_password"]["newpassword"].value.length;
			              if(k<8)
                                {
							        document.getElementById("spannew").innerHTML="Please enter at least 8 characters";
							        return false;
                                }
...
function validateConfirmPassword()
		{
			...
			else
			{
				var k = document.forms["form_change_password"]["confirmpassword"].value.length;
			              if(k<8)
                                {
							        document.getElementById("spanconfirm").innerHTML="Please enter at least 8 characters.";
							        return false;
                                }
