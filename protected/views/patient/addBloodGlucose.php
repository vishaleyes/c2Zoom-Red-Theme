			...
			<div class="row" id="BloodGlucoseDiv">
				<div class="col-md-12">
					...
					{?> selected="selected" <?php } ?> >mg/dL</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                * </span>
												...
												<div class="col-md-8">
												<input class="form-control form-control-inline input date-picker" data-required="1" size="16" readonly="readonly" autocomplete="off" placeholder="Ex. <?php echo date("m/d/Y"); ?>" id="report_date" name="report_date" type="text" value="<?php 
					...
					<!-- 
					<input class="form-control form-control-inline input date-picker" data-required="1" size="16" data-date-format="mm/dd/yyyy" data-date-end-date="+0d" data-date-start-date="-105y"  readonly="readonly" autocomplete="off" placeholder="Ex. <?php //echo date("Y-m-d") ?>" id="report_date" name="report_date" type="text" value="<?php 
					/*if(isset($bloodGlucoseData['report_date']) && ($bloodGlucoseData['report_date'])!='') 
					{ echo date("m/d/Y",strtotime($bloodGlucoseData['report_date'])) ;
					} */
					?>"/ >
					...
					?></textarea>
								...
								<div class="form-actions fluid">
                                    ...
                                    <input type="hidden" name="blood_glucose_id" value="<?php echo $_REQUEST['blood_glucose_id']; ?>"  />
										...
										<a class="btn red" href="<?php echo Yii::app()->params->base_path ; ?>patient/BloodGlucoseListing">Cancel</a>
									</div>
								</div>
							</form>
							<!-- END FORM-->
