				...
				<div class="col-md-12">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-tachometer"></i>Medical History Details
							</div>
							<div class="tools">
                    ...
                    <div>
                            <a class="btn green" href="<?php echo Yii::app()->params->base_path ; ?>patient/addMedicalHistory"><i class="fa fa-plus"></i>&nbsp;Add Medical History</a>
                            </div>
                          ...
                          <br />
							...
							<tr>
                                ...
                                <?php
										if(trim($row['when_started']) != "" ) 
											  {
												  $when_started = date("d/m/Y",strtotime($row['when_started'])) ; 
                                ...
                                <?php
										if(trim($row['when_stopped']) != "" ) 
											  {
												  $when_stopped = date("d/m/Y",strtotime($row['when_stopped'])) ; 
                                ...
                                <td>
                                <a data-toggle="modal" href="#basic<?php echo $row['medication_id'] ?>"><i class="fa fa-eye"></i></a>&nbsp;
										...
										<div class="modal-body">
											...
											?>
                                             ...
                                             <?php
												...
												{ $modified_at = date("d/m/Y H:i:s",strtotime($row['modified_at']));} 
												else 
												{ $modified_at = "---" ; } 
											?>
                                             <tr>
                            ...
                            <a title="Edit" href="<?php echo Yii::app()->params->base_path ; ?>patient/addMedication/medication_id/<?php echo $row['medication_id'] ?>"><i class="fa fa-pencil"></i></a>&nbsp;
                                                                   
                                    <a title="Delete" onclick="confirmDelete(<?php echo $row['medication_id'] ?>)" href="#" ><i class="fa fa-times"></i></a>
