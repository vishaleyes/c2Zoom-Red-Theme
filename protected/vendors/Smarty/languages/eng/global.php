...
$messages['_PHONE_VALIDATE_NOT_VALID_ACCOUNTMANAGER_']="Not valid phone number";
$messages['_EMAIL_VALIDATE_ACCOUNT_MANAGER_']="Specify email, phone or both";
$messages['_VALID_US_PHONE_']="Please enter valid phone number.";
...
$messages['_ANESTHESIA_TYPE_REQ_']=" Anesthesia is required. ";
$messages['_REPORT_DATE_REQ_']=" Report data is required. ";
$messages['REACTION_REQ']=" Reaction is required. ";

$messages['_PATIENT_ID_REQ_']=" patient_id is required. ";
$messages['_DOCUMENT_ID_REQ_']=" document_id is required. ";
$messages['_DOCTOR_ID_REQ_']=" doctor_id is required. ";
